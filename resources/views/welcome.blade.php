                  ...
                  <form method="POST" action="{{ route('login') }}">
                    ...
                    <div class="col-12 mt-0">
                      ...
                      @endif
                        ...
                        <input type="email" id='email' name="email" class="form-control" placeholder="Login ID" value="{{ old('email') }}">
                        @error('email')
                    ...
                    <div class="col-12">
                      ...
                      <a href="{{ route('reset_form')}}" class="btn btn-secondary" type="submit">Reset</a>
