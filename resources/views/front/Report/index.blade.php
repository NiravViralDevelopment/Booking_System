            ...
            <div class="card-body">
              ...
              <form>
               <div class="row">
                ...
                <!-- <div class="col-sm-6 mt-3">
                  <label for="active" class="form-label">Report Type</label>
                  <select class="minimal form-select" id="report_id">
                    <option value='1' >Advance Report</option>
                    <option value='2' >Booking Report</option>
                  </select>
                </div> -->
              ...
              <div class="report_table_sec">
                <div class="row">
                  <div class="col-sm-6">
                    <div class="pagetitle">
                      <h1>{{ $facility_name}} - Attendance Report</h1>
                    </div>
                  </div>
